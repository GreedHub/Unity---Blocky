            ...
            for(int y=0; y< _ySize; y++){
                ...
                for(int z=0; z< _zSize; z++){
                   ...
                   // Debug.Log($"Heightmap: {heightMap} | dirtHeight: {dirtHeight}");
                    ...
                    blocks[x,y,z].material = (y > dirtHeight) ?  BlockMaterials.air : BlockMaterials.dirt;
        ...
        for(int x=0; x< _xSize ; x++){
            ...
            for(int y=0; y< _ySize; y++){
                ...
                for(int z=0; z< _zSize; z++){        
                    ...
                    if(blocks[x,y,z].material == BlockMaterials.air) {vert++; continue;}; 
                    ...
                    /* FRENTE */
                    if((x==0 &&blocks[x,y,z].material != BlockMaterials.air) || (x>0 && blocks[x-1,y,z].material == BlockMaterials.air)){
                    ...
                    /* FONDO */
                    if((x==xSize-1 &&blocks[x,y,z].material != BlockMaterials.air) || (x < xSize-1 && blocks[x+1,y,z].material == BlockMaterials.air)){
                    ...
                    /* PISO */
                    if((y==0 &&blocks[x,y,z].material != BlockMaterials.air)|| (y>0 && blocks[x,y-1,z].material == BlockMaterials.air)){
                    ...
                    /* TECHO */
                    if(y<ySize-1 && blocks[x,y+1,z].material == BlockMaterials.air){
                        _triangles.Add(formulas[7]);
                        _triangles.Add(formulas[6]);
                        _triangles.Add(formulas[2]);
                    ...
                    /* LATERAL */
                    if((z==0 &&blocks[x,y,z].material != BlockMaterials.air) || (z>0 && blocks[x,y,z-1].material == BlockMaterials.air)){
                        _triangles.Add(formulas[6]);
                        _triangles.Add(formulas[4]);
                        _triangles.Add(formulas[0]);
                    ...
                    /* LATERAL2 */
                    if((z==zSize-1 &&blocks[x,y,z].material != BlockMaterials.air) || (z<zSize-1 && blocks[x,y,z+1].material == BlockMaterials.air)){
